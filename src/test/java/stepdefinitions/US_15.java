...
public class US_15 {
    ...
    public void user_click_on_dropdown_menu(String string) throws InterruptedException {
        ...
        action.click(objectUs14.myOperationsButton);
        Thread.sleep(4000);
    }

    @Then("User  click on {string}")
    public void user_click_on(String string) {
        Select select=new Select(object.myAccounts);
    ...
    public void user_see_all_account_types(int row,int column) {
    ...
    public void user_see_all_transaction() {
